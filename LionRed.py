...
#!/usr/bin/env python3
"""
 bản quyền tool by nhật quyền hạn chế edit 
"""
...
quotes = [
  # Author
  'Copyrigt : Nguyễn Nhật Quyền LionRed Beta',
  'Copyrigt : Nguyễn Nhật Quyền LionRed Beta',
  'Copyrigt : Nguyễn Nhật Quyền LionRed Beta.',
  'Copyrigt : Nguyễn Nhật Quyền LionRed Beta',
  'Copyrigt : Nguyễn Nhật Quyền LionRed Beta',
...
def welcome():
  ...
  printf(Center.XCenter(Colorate.Vertical(Colors.red_to_purple, f'''
    ...
    ╔═════════╩═════════════════════════════════╩═════════╗
                           LionRed  
      ➡ Sever Discord        |         https://discord.gg/dXzZu7Gu
      ➡ methods              |         Tài Liệu L7/L4/Bypass 
      ➡ BuidingTool          |         Người Làm Tools
  ...
  while True:
    ...
    if 'BuidingTool' in cmdl:
      ...
      ╔═════════╩═════════════════════════════════╩═════════╗
        ...
        ➡ coder                :       @NguyenNhatQuyen
        ➡ Lên Ý Tưởng          :     @JuicexNet & @AuraNetz
        ➡ Đội Ngũ              :       LionHacking Team
        ➡ Zalo Support         :        0792161421
        ➡ LionRed Thanks       :      #Thanks Bạn Đã Tải
